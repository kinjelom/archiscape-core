...
class ContentStoreInternalResourceIT {
        ...
        restContentStoreInternalMockMvc
            .perform(
                post(ENTITY_API_URL)
                    ...
                    .content(TestUtil.convertObjectToJsonBytes(contentStoreInternal))
            )
    ...
    void putNewContentStoreInternal() throws Exception {
        ...
        restContentStoreInternalMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedContentStoreInternal.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedContentStoreInternal))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingContentStoreInternal() throws Exception {
        ...
        restContentStoreInternalMockMvc
            .perform(
                put(ENTITY_API_URL_ID, contentStoreInternal.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(contentStoreInternal))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamContentStoreInternal() throws Exception {
        ...
        restContentStoreInternalMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(contentStoreInternal))
            )
    ...
    void patchNonExistingContentStoreInternal() throws Exception {
        ...
        restContentStoreInternalMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, contentStoreInternal.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(contentStoreInternal))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteContentStoreInternal() throws Exception {
        ...
        restContentStoreInternalMockMvc
            .perform(delete(ENTITY_API_URL_ID, contentStoreInternal.getId().toString()).accept(MediaType.APPLICATION_JSON))
